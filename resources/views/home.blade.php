...
<html>
		...
		<div class="ubea-container">
			<div class="row">
				<div class="col-sm-2 col-xs-12">
					<div id="ubea-logo"><a href="">EMS <em>.</em></a></div>
				</div>
			...
			<ul class="slides">
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
							   <h2>Wide Range of Event Templates</h2>
		   	...
		   	<li style="background-image: url(/home/images/img_bg_2.jpg);">
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
							<h2>Collaborative Event Oraganization</h2> 
		   	...
		   	<li style="background-image: url(/home/images/img_bg_3.jpg);">
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
							<h2>A Single Platform to Meet Your Customers</h1> 
	...
	<div class="ubea-section-overflow">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="ubea-heading">
							<h2 class="ubea-left">About Us!</h2>
							...
							<div class="col-md-12">
								<div class="feature-left">
									...
									<div class="feature-copy">
										...
										<p >Our system users can manage their event using our pre-defined templates in an easy and effiecient way. Even users without having any knowledge about event planing can also use our system to manage their events.</p> 
                    					<p>Also you can edit or create&nbsp;</p>
									</div>
								</div>
							</div>
							<div class="col-md-12">
		...
		<div class="ubea-section" id="ubea-faq" data-section="contact">
			<div class="ubea-container">
				<div class="row">
	...
	<div id="ubea-contact" data-section="contact" class="ubea-cover ubea-cover-sm" style="background-image:url(/home/images/240_F_89178420_kQXKb5Zin14s9C7p0sSKL4KaITEZSs43.jpg);">
		<div class="overlay"></div>
		<div class="ubea-container">
			<div class="row text-center">
				<div class="display-t">
					<div class="display-tc">
						<div class="col-md-12">
							<h3>If you have inqueries please email us at <a href="#">emsbyucsc@gmail.com</a></h3>
						</div>
					</div>
				</div>
			</div>
